...
export class Observable<T = unknown> {
    ...
    addValueChangeListener(listener: (value: T) => void) {
    ...
    removeValueChangeListener(listener: (value: T) => void) {
...
function subscribe<T>(observable: Observable<T>, listener: (value: T) => void) {
